...
export class ProductService {
  private productList = [
    new shopping('https://thumbs.dreamstime.com/b/chicken-dum-biryani-white-bowl-traditional-indian-one-pot-dish-background-high-angle-view-156498926.jpg', 'Chicken Biriyani ', 180),
  ...
  removeCartItem(product : any){
    this.shoppedList.map((a: any, index :any)=>{
      if(product.id ===a.id){
        this.shoppedList.splice(index,1);
      }
    })
  }
